...
class BDWKDOC(BaiduWK):
    ...
    def get_pure_addr_list(self):
        ...
        pure_addr_list = list()
        # 获取文档标题
        print("one111",etree.HTML(source_html).xpath("//title/text()")[0])
...
def main():
    try:
        #url = "https://wenku.baidu.com/view/665019d06bec0975f465e25d.html?from=search" #input("请输入资源所在的网址:")
        url = 'https://wenku.baidu.com/view/10d9bf1f7ed5360cba1aa8114431b90d6c8589b7.html'
